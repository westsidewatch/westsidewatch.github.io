...
const stats={works:0,authority:0,languages:new Map(),rawLanguages:new Map(),authors:new Map(),subjects:new Map(),years:new Map(),sources:new Map(),missing:{title:0,language:0,author:0,subjects:0},chinese:{works:0,authors:new Map(),subjects:new Map(),years:new Map()},samples:{chinese:[]}};
