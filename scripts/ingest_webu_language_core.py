...
def main() -> None:
    try:
        ...
        witness = TextWitness(
            witness_id="witness.english.webu",
            language="en",
            edition="World English Bible Updated",
            source_id="source.ringletech.webu_open_bible",
            snapshot=SNAPSHOT,
            license_id="CC0-1.0",
            metadata={"source_repo":"ringletech/webu-open-bible"},
        )
        ...
        result = {
            "status":"PASS" if len(books)==66 and not errors and refs else "FAIL",
            "study":"language_core.english_webu.full_witness_ingestion",
            ...
            "coverage_policy":"PASS requires all 66 canonical books mapped",
        }
