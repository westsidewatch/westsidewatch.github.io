...
(() => {
  ...
  window.ONE_STUDIO_ASSET_REGISTRY=Object.freeze({mode:"ONE_STUDIO_VERSIONED_ASSETS",version:"2026-08-21-v12",doreAssetsAllowed:false,generatedAssetsAllowed:true,nonDoréHistoricalAssetsAllowed:true,runtimeReplacementAllowed:false,editorialReplacementAllowed:true,assets,chapterMap,registerAsset,replaceAsset,registerChapter,reassignChapter,getAsset,getAssignment,getHistory,resolve});
  registerAsset("REV-02-DORE-STUDIO-001",{src:"/api/dore/assets/file?code=ONE-REV-02-DORE-FINAL",alt:"启示录第二章：基督在七灯台中间向教会说话，约翰俯伏在前",title:"Among the Lampstands",source:"/api/dore/assets/file?code=ONE-REV-02-DORE-FINAL",artist:"Westside Watch Engraving Studio · Doré continuation",origin:"ONE_STUDIO_DORE_CONTINUATION",palette:"MONOCHROME_ENGRAVING",scripture:"Revelation 2:1–29",approvedAt:"2026-08-18",note:"Editorial FINAL FULL PNG. Canonical Revelation 2 artwork."});
  registerChapter(66,2,"REV-02-DORE-STUDIO-001",{priority:"P7_ONE_STUDIO_FIXED",basis:"EDITORIAL_FINAL_FULL_PNG"});
  registerAsset("OBA-01-DORE-STUDIO-002",{src:"/api/dore/assets/file?code=ONE-OBA-01-DORE-STUDIO",alt:"Obadiah 1:1–21 · ONE Studio engraving",title:"From the Clefts of the Rock",source:"/api/dore/assets/file?code=ONE-OBA-01-DORE-STUDIO",artist:"Westside Watch Engraving Studio · Doré continuation",origin:"ONE_STUDIO_DORE_CONTINUATION",palette:"MONOCHROME_ENGRAVING",scripture:"Obadiah 1:1–21",approvedAt:"2026-08-21",note:"Editorially approved Doré-continuation Studio plate. SHA-256 31c0e72f3e1728fbb9be55df5241f5e69e6ea9d7ccdb2f2572809a357fd44da4; 3521988 bytes."});
  registerChapter(31,1,"OBA-01-DORE-STUDIO-002",{priority:"P7_ONE_STUDIO_FIXED",basis:"EDITORIAL_FINAL_NATIVE_BINARY"});
  registerAsset("JUD-01-DORE-STUDIO-001",{src:"/api/dore/assets/file?code=ONE-JUDE-01-MICHAEL-MOSES-STUDIO",alt:"Jude 9: Michael the archangel disputes with the devil concerning the shrouded body of Moses in a vast wilderness",title:"The Lord Rebuke You",source:"/api/dore/assets/file?code=ONE-JUDE-01-MICHAEL-MOSES-STUDIO",artist:"Westside Watch Engraving Studio · Doré continuation",origin:"ONE_STUDIO_DORE_CONTINUATION",palette:"MONOCHROME_ENGRAVING",scripture:"Jude 9",approvedAt:"2026-08-21",note:"Human-approved native PNG cover. The unknown dispute location and cause remain visually withheld; neither party possesses or touches Moses' body. SHA-256 048e91c7752aeb9493bba8ae8716c0faa4d0a6189ee4a7923e6f2394ac85f568; 1024x1536."});
  registerChapter(65,1,"JUD-01-DORE-STUDIO-001",{priority:"P7_ONE_STUDIO_FIXED",basis:"EDITORIAL_FINAL_NATIVE_BINARY"});
