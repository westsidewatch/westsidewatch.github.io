...
>
> Purpose: preserve execution order, progress, gates, and completion state for the remaining ONE work so it does not exist only in chat.
>
> Deletion rule: delete this file after the Missing Plate backlog reaches 0 and Atlas / Scripture Graph / Search are fully shipped and verified. This is not a permanent design specification.
...
7. Final cleanup task after all work is complete: delete this file.
...
1. [ ] 25 耶利米哀歌 — 1 missing, 4/5 covered. Finish first.
