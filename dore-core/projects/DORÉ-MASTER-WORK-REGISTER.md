...
| 1A | MEM-SWEEP-01 | Whole-system Memory Consolidation Sweep | ACTIVE_PARALLEL | Constitution, sensory diagnostics, current architecture/roadmap, R2/runtime families and Conversation Memory Layer v1 contract/tests reviewed; ledgers active | Continue bounded benchmarks/tests/workflows batch, then broader memory/knowledge/product history |
...
| 10 | SEARCH | Doré Bible Search / public encounter surface | MAINTENANCE + DISCOVERY | Search exists; Scripture/video routes developing; candidate first Doré public conversation/discovery surface | Preserve search quality while testing Search → Ask/Discover → Scripture/resource/ONE/Library pathways |
