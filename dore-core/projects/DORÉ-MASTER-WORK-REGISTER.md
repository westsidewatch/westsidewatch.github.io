...
| 10 | SEARCH | Doré Bible Search / public encounter surface | MAINTENANCE + DISCOVERY | Search exists with explicit negative-relevance regression protection; Search cognition gate is still recorded `TAUGHT`, not concept/product complete | Preserve public search quality; later run unseen intent-transfer + live SEARCH/scoped/QUESTION/HYBRID routing gates without interrupting P01 |
