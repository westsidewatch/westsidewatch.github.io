...
| 5 | VIS-LEARN | Doré modern design / editorial / spatial design education | ACTIVE_PARALLEL | Formal learning requirement established: modern web, editorial/independent magazine, media, books/catalogues, museum/exhibition, wayfinding and architecture; typography/detail standards included | Doré produces a sufficiently broad reference corpus and demonstrates transferable design judgment rather than imitation | CORE |
