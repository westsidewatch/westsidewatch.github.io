...
| 17A | CONV-MEM-V1 | Scoped Conversation Memory Layer | ACTIVE_PARALLEL / IMPLEMENTING | D1 conversation/message/chunk schema, scoped memory API, dedupe, optional R2/Vectorize hooks and anti-cross-talk contract test exist; no production D1 replay or Vectorize retrieval is yet verified | Production-write + exact scoped replay + cross-conversation isolation test; then R2 recovery and scoped Vectorize recall before broader conversation integration |
