...
| 6 | VIS-GRAMMAR | Westside visual grammar from Doré engraving + Dawn | ACTIVE_PARALLEL / BUILDING | Named engraving-brand-system project establishes source-grammar-not-page-template, fresh-redrawing preference, cross-media deliverables and restraint rules; production mark/texture/stroke library plus real-page/mobile/print proof are not yet verified. Evidence: `DORÉ-VISUAL-GRAMMAR-EVIDENCE-LEDGER-2026-08-26.md` | Build reusable purpose-drawn Doré-derived marks/backgrounds/textures/strokes and prove them on real digital + print/ministry specimens before Brand V1 propagation |
