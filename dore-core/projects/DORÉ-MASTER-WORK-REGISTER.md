...
| 11 | ONE | Scripture study product | MAINTENANCE | Existing study product | Consume trusted Library/Scripture relationships; later proven Brand V1 |
...
| 17 | CONVERSATION | Doré direct Conversation Runtime | ACTIVE_PARALLEL / INTERNAL_ALPHA; PUBLIC PARKED | A1/A2/A3 primitives are CI-verified; a persisted real P01 rehearsal now records a grounded durable contribution plus rejected transient suggestion, and fresh-context replay assertions exist; newest replay workflow execution was not independently observed in Sweep | Confirm one successful current replay execution and evaluate all Internal Alpha gates; public conversation remains unauthorized/parked |
| 17A | CONV-MEM-V1 | Scoped Conversation Memory Layer | ACTIVE_PARALLEL / IMPLEMENTING | D1 conversation/message/chunk schema, scoped memory API, dedupe, optional R2/Vectorize hooks and anti-cross-talk contract test exist; no production D1 replay or Vectorize retrieval is yet verified | Production-write + exact scoped replay + cross-conversation isolation test; then R2 recovery and scoped Vectorize recall before Conversation Alpha integration |
