...
- authoritative Jewish Scriptures → apostolic usage → later Christian canon formation.

The missing faculty is not another lexical lookup. It is the ability to reconstruct continuity, development, competing trajectories and canonical relationships across historically distinct corpora without retrojection or false discontinuity.
...
4. Translation-language mediation: Hebrew / Aramaic / Greek.
5. Practicum A — `שָׂטָן` / adversary → Second Temple → NT.
6. Practicum B — divine Spirit → Second Temple → NT.
7. Practicum C — Scripture authority / collection / canon trajectory.
8. Blind transfer on an unseen concept.
