...
class ZoteroTranslationAdapter:
    ...
    Dawn does not embed Zotero translator code. The provider is injected as a
    translation-server URL, keeping Core small while retaining real translator
    behavior and provider provenance.
    """
