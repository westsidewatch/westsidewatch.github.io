...
try:
    ...
    # Register the existing canonical Italian Editorial Atlas as a first-class Design page.
    ...
    # Runtime editor JS owns clickability; make Atlas a supported page target.
