...
def _page():
    return {
        ...
        'canvas': {'w': 1440, 'h': 960},
        'nodes': [
            {'id':'p1-current','type':'prototype','title':'Living Current Native','body':'8:5 horizontal current · native overflow + scroll snap','x':0,'y':0,'w':1440,'h':960},
        ],
        'design_experiment': {
