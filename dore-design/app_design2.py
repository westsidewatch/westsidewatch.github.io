...
import design2_phase4_http,design2_phase5_http,design2_phase6_http,design2_phase7_http,design2_phase8_http,design2_phase9_http
...
design2_phase8_http.install(current.H,current.visual.base)
design2_phase9_http.install(current.H,current.visual.base)
