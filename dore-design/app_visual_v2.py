...
multipage_wysiwyg.SUPPORTED.update({'multiwrite-home','multiwrite-cover',motion_prototypes.PAGE_ID,living_water_candidate.PAGE_ID,living_water_candidate_02.PAGE_ID,living_water_second_layer_lab.PAGE_ID});template_library.register_runtime_pages(visual.base,homepage_candidates,multipage_wysiwyg);_original_render_canvas=multipage_wysiwyg.render_canvas
