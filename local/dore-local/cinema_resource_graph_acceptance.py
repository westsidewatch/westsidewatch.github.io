...
print('PARADISE_CINEMA_RESOURCE_GRAPH=PASS works=10 moments=%d journeys=%d overrides=0 derivation=biblical-anchor special=1' % (len(moments['items']),len(journeys['journeys'])))
