...
def _persist_evidence(design,task_id,checks):
 ...
 evidence={
  'schema':'dore.living-water-bloom.evidence.v2','task_id':task_id,'experiment_id':design.get('experiment_id'),'checks':checks,
