...
class DimensionalPublishingCapability:
    ...
    def compile(self, *, title: str, manuscript: str, thesis: str = "", context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return asdict(EditorialPlan(
            ...
            publication={"journal_feature": True, "book_ready_pipeline": True, "research_collection": True, "image_prompt_discovery": True, "contextual_emergence": True, "audio_optional": True, "map_optional": True},
            degraded=degraded,
        ))
